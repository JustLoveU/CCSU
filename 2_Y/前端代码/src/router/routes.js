...
const frameIn = [
  {
    ...
    children: [
      ...
      },
      {
        ...
        component: _import('profile/list')
      },
      {
        path: 'edit',
        name: 'edit',
      ...
      },
      {
        ...
        component: _import('friend/friend')
      },
      {
        path: 'friend-add-or-update',
        name: 'friend-add-or-update',
        meta: {
          title: '友链修改',
          auth: true
        },
        component: _import('friend/friend-add-or-update')
      },
      {
        path: 'user',
        name: 'user',
      ...
      },
      {
        ...
        component: _import('user/user-add-or-update')
      },
      // 系统 前端日志
      {
        path: 'log',
