<template>
  <el-dialog
    ...
    <el-form-item label="留学申请出国时间" prop="outsideDate">
      <el-input v-model="dataForm.outsideDate" placeholder="留学申请出国时间"></el-input>
    </el-form-item>
    ...
    <el-form-item label="申请时间" prop="applyDate">
      <el-input v-model="dataForm.applyDate" placeholder="申请时间"></el-input>
    </el-form-item>
    </el-form>
    ...
    data () {
      return {
        ...
        dataRule: {
          ...
          address: [
            { required: true, message: '留学申请预选区域不能为空', trigger: 'blur' }
          ],
          degree: [
            { required: true, message: '留学申请计划攻读学位不能为空', trigger: 'blur' }
          ],
          years: [
            { required: true, message: '留学申请已学习年限不能为空', trigger: 'blur' }
          ],
          major: [
            { required: true, message: '留学申请在读专业不能为空', trigger: 'blur' }
          ],
          outsideDate: [
            { required: true, message: '留学申请出国时间不能为空', trigger: 'blur' }
          ],
          university: [
            { required: true, message: '留学申请就读院校不能为空', trigger: 'blur' }
          ],
          score: [
            { required: true, message: '留学申请成绩不能为空', trigger: 'blur' }
          ],
          tel: [
            { required: true, message: '留学申请手机号码不能为空', trigger: 'blur' }
          ],
          applyDate: [
