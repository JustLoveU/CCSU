		...
		<view>
			<view style="margin: 10rpx;">
				<navigator url="/pages/index/search/search" navigateTo>
					...
					<u-search placeholder="搜索大学" v-model="keyword" @change="toPage('/pages/index/search/search')" @click="toPage('/pages/index/search/search')" :disabled="true" :show-action="false"></u-search>
				</navigator>
			</view>
		</view>
		<view>
