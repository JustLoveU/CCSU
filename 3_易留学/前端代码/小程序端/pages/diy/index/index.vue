<template>
	<view>
		<view>
			<cover-image src="https://ou.lomtom.top/img/diy_top.png"></cover-image>
			<view style="padding: 20rpx;">
				<u-form :model="form" ref="uForm" label-position="left" label-width="200" label-align="left" label-style="color:#ebebeb">
