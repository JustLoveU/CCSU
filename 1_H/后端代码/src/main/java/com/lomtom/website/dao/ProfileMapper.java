...
public interface ProfileMapper {
    ...
    @Insert("INSERT INTO lab_profile" +
            "(`profile_picpath`, `profile_intro`, `profile_cnname`, `profile_education`,`profile_position`, `profile_telephone`, `profile_email`, `profile_studydir`, `profile_address`, `profile_workexp`, `profile_edubackground`) " +
            "VALUES (#{profilePicpath} , #{profileIntro} , #{profileCnname} , #{profileEducation} ,#{profilePosition} , #{profileTelephone} , #{profileEmail} , #{profileStudydir} , #{profileAddress} , #{profileWorkexp} , #{profileEdubackground} );\n")
