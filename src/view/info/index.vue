<template>
	<div >
		...
		<div style="top: -160px;position: relative;margin: 0 100px;" class="content">
	...
	export default {
		...
		methods: {
			...
			getHotList(type) {
				...
				this.$api.getRequest(this.$url.INTERFACES.infoTypeList, data).then(res => {
					if (res.status == 200) {
