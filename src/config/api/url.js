const ONLINEHOST = "https://ou.lomtom.top/", 
LOGINHOST = "https://ou.lomtom.top/", 
HOUSEONLINEHOST = "https://ou.lomtom.top",
// const ONLINEHOST = "http://localhost:8888/", 
// LOGINHOST = "http://localhost:8888/", 
// HOUSEONLINEHOST = "http://localhost:8888",
...
const APILIST = {
	root:					"/",
  login:					"/user/login",				//登录
  sendCode:					"mail/send",					//发送验证码
  register:					"/user/register",				//注册
  userOne:					"user/info/",				//获得一个用户
  userUpdate:				"/user/update",				//更新一个用户
  infoTypeList:				"infoType/hot",			//获取首页热门板块
  infoSearch:				"info/search",			//获取搜索资讯列表分页
  infoList1:				"info/listByType",				//获取资讯列表分页
  infoList:					"/info/hot/6",				//获取首页热门板块
  InfoListByUniversity:		"info/ListByUniversity/",	//通过大学获取政策
  infoOne:					"/info/info/",				//获取首页热门板块
  universityPage:			"/university/list",			//获取top大学
  universityList:			"university/hot/3",			//获取top大学
  ...
  universityList2:			"university/hot/6",			//获取
  ...
  ResultOneByUser:			"/result/getOneByUserId/",	//获取申请结果
}
