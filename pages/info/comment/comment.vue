<template>
	<view>
		...
		<view style="background-color: #FFFFFF;padding-left:30rpx ;padding-right: 30rpx;">
			...
			<u-line />
			<navigator url="/pages/comment/index/index" navigateTo><view class="u-text-center" style="padding: 30rpx;font-size: 24rpx;color: #828282;">查看更多资讯</view></navigator>
		</view>
		<view style="margin: 10px;"></view>
		<!-- <view class="card">
			<label>专业</label>
